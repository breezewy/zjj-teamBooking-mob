        ...
        <ul class="edit_list">
          <li class="edit_item">
            ...
            <input
              class="list_in"
              type="password"
              v-model.trim="dataForm.originPassword"
              placeholder="原密码"
            />
          </li>
          <li class="edit_item">
            ...
            <input
              class="list_in"
              type="password"
              v-model.trim="dataForm.resetPassword"
              placeholder="新密码"
            />
          </li>
          <li class="edit_item">
            ...
            <input
              class="list_in"
              type="password"
              v-model.trim="dataForm.sureResetPassword"
              placeholder="确认密码"
            />
          </li>
        </ul>
    ...
    updateHandle() {
      ...
      this.$http
        ...
        .then(({ data: res }) => {
          ...
          Toast("修改成功");
          setTimeout(() => {
            this.$router.push({ path: "/guide/my" });
          }, 700);
        })
        .catch(() => {
          Toast("服务器异常，请稍后再试");
